...
"Are we not pure? No sir! Panamas moody Noriega brags. It is garbage! Irony dooms a man; a prisoner up to new era.",
...
"Did I do, O God, did I as I said Id do? Good! I did.",
...
"Gabes on a nosebag.",
"Gaby H.s art saved Evas trashy bag.",
"Galoots, too, lag.",
...
"Leons noel.",
"Lepers repel.",
"Let OHara gain an inn in a Niagara hotel.",
...
"Naive Evian",
"Name no one man.",
"Name no side in Eden, Im mad! A maid I am, Adam mine; denied is one man.",
"Name not one man.",
"Name now one man.",
"Name tarts? No, medieval slave, I demonstrate man!",
"Names Abel, a male, base man.",
"Naomi, did I moan?",
"Nat tan",
"Nate bit a tibetan.",
"Navan" ,
...
"Pull up, Eva, were here! Wave! Pull up!",
"Pusillanimity obsesses Boy Tim in All Is Up.",
"Put Eliots toilet up.",
"Race fast, safe car!",
"racecar",
"radar",
...
five = a.select {|x| x.length >= 15 && x.length <= 20}

seven = a.select{|x| x.length >= 25 && x.length <= 35}
...
=begin print "How long do you want the poem?"
number = gets.chomp
pal(number)
=end 
pal
